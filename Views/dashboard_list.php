...
<script>
    ...
    function getTranslations(){
        return {
            'Error': <?php echo json_encode(tr('Error')) ?>,
            'Save': <?php echo json_encode(tr('Save')) ?>,
            'Done': <?php echo json_encode(tr('Done')) ?>,
            'Error loading': <?php echo json_encode(tr('Error loading')) ?>,
            'Found %s entries': <?php echo json_encode(tr('Found %s entries')) ?>,
            'JS Error': <?php echo json_encode(tr('JS Error')) ?>,
            'Reload': <?php echo json_encode(tr('Reload')) ?>,
            'Loading': <?php echo json_encode(tr('Loading') . '…') ?>,
            'Saving': <?php echo json_encode(tr('Saving') . '…') ?>,
            'Label this dashboard with a name': <?php echo json_encode(tr('Label this dashboard with a name')) ?>,
            'Must be unique. Short title to use in URL.\neg \"roof-solar\"': <?php echo json_encode(tr('Must be unique. Short title to use in URL.\neg \"roof-solar\"')) ?>,
            'Adds a \"Default Dashboard\" bookmark in the sidebar.\nAlso visible at \"dashboard/view\"': <?php echo json_encode(tr('Adds a \"Default Dashboard\" bookmark in the sidebar.\nAlso visible at \"dashboard/view\"')) ?>,
            'Allow this Dashboard to be viewed by anyone': <?php echo json_encode(tr('Allow this Dashboard to be viewed by anyone')) ?>,
            'Allow this Dashboard on the menu': <?php echo json_encode(tr('Allow this Dashboard on the menu')) ?>,
            'Clone the layout of this dashboard to a new Dashboard': <?php echo json_encode(tr('Clone the layout of this dashboard to a new Dashboard')) ?>,
            'Edit this dashboard layout': <?php echo json_encode(tr('Edit this dashboard layout')) ?>,
            'Delete this dashboard': <?php echo json_encode(tr('Delete this dashboard') . '…') ?>,
            'View this dashboard': <?php echo json_encode(tr('View this dashboard') . '…') ?>,
            'Edit Layout': <?php echo json_encode(tr('Edit Layout')) ?>,
            'default': <?php echo json_encode(tr('Default')) ?>,
            'Not unique': <?php echo json_encode(tr('Not unique')) ?>,
            'Delete "%s"': <?php echo json_encode(tr('Delete "%s"')) ?>,
            'Deleting a dashboard is permanent': <?php echo json_encode(tr('Deleting a dashboard is permanent')) ?>,
            'Are you sure you want to delete ?': <?php echo json_encode(tr('Are you sure you want to delete ?')) ?>,
            'Added': <?php echo json_encode(tr('Added')) ?>
        }
    }
</script>
