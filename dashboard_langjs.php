...
LANG_JS["Error Message"] = '<?php echo addslashes(_("Error Message")); ?>';
LANG_JS["Error message displayed when timeout is reached"] = '<?php echo addslashes(_("Error message displayed when timeout is reached")); ?>';
...
LANG_JS["Normal"] = '<?php echo addslashes(_("Normal")); ?>';
LANG_JS["Number of blocks"] = '<?php echo addslashes(_("Number of blocks")); ?>';
LANG_JS["Number of blocks to display"] = '<?php echo addslashes(_("Number of blocks to display")); ?>';
LANG_JS["Oblique"] = '<?php echo addslashes(_("Oblique")); ?>';
LANG_JS["Offset"] = '<?php echo addslashes(_("Offset")); ?>';
LANG_JS["Scale"] = '<?php echo addslashes(_("Scale")); ?>';
LANG_JS["Static offset. Subtracted from value before computing"] = '<?php echo addslashes(_("Static offset. Subtracted from value before computing")); ?>';
...
LANG_JS["IP address of server (server must have cross origin allowed to work, will not generally work on servers other than localhost)"] = '<?php echo addslashes(_("IP address of server (server must have cross origin allowed to work, will not generally work on servers other than localhost)")); ?>';
...
// kwhperiod_render.js
LANG_JS["Annual data"] = '<?php echo addslashes(_("Annual data")); ?>';
LANG_JS["Convert the periodic energy use to kWh per Day"] = '<?php echo addslashes(_("Convert the periodic energy use to kWh per Day")); ?>';
LANG_JS["Period kWh/day"] = '<?php echo addslashes(_("Period kWh/day")); ?>';
LANG_JS["Set to True to use last year's data"] = '<?php echo addslashes(_("Set to True to use last year's data")); ?>';
