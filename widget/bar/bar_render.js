...
function bar_widgetlist()
{
    ...
    addOption(widgets["bar"], "minmaxcolour",   "colour_picker",    _Tr("Colour"),          _Tr("Colour for min. and max. bars"),                                               []);
                ...
                )
{
    ...
    if (minmaxcolour.indexOf("#") === -1) minmaxcolour = "#" + minmaxcolour;  // Fix missing "#" on colour if needed
