...
function sun_draw(){
  $('.sun').each(function(index) {
    ...
    if (val != (associd[feedid]['value'] * 1).toFixed(3) || redraw == 1)
    {
      ...
      var cap_height = sun_height/16;
      var cap_width = sun_width/3;
      var line_width = 2;
      var margin = 1;
      ...
      context.fillText(data.toFixed(1), start_x + centerX - 15, start_y + centerY - 30, sun_width);
      context.fillText(units, start_x + centerX - 20, start_y + centerY - 15, sun_width);
    }
  });
}
